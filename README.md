...
• Includes product, pricing, quantity, and order status details.
• Contains customer-level information for retention analysis.
• Supports time-series and trend-based analysis.
• Useful for sales forecasting and revenue analysis.
• Suitable for EDA, business analytics, and ML models.
• Represents real-world large-scale transactional data.
Data Source : https://www.kaggle.com/datasets/guriya79/pakistans-largest-e-commerce-dataset-20162018
